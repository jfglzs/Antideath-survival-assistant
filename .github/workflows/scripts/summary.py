...
# Source: https://github.com/TISUnion/Carpet-TIS-Addition/blob/master/.github/workflows/scripts/summary.py
#
...
# Modified by: jasonxue
# Modified: excluded javadoc jars when selecting the primary mod artifact
        ...
        for subproject in settings["versions"]:
            ...
            file_paths = [
                ...
                if all(
                    ...
                    for classifier in ["sources", "dev", "shadow", "javadoc"]
                )
            ]
            if len(file_paths) == 0:
                file_name = "*not found*"
