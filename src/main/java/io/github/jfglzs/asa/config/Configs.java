...
public class Configs implements IConfigHandler {
    ...
    @Config(tab = Tab.FUNCTIONS) public static final ConfigStringList FAKE_PLAYER_KILL_AURA_WHITELIST = new ConfigStringList("killAuraWhiteList", ImmutableList.of(), "假人杀戮光环白名单（仅对名单内玩家生效，精确匹配，忽略大小写）").apply(ALL);
    ...
    @Config(tab = Tab.FUNCTIONS) public static final ConfigBooleanHotkeyed MINI_HUD_FPS_OPT = new ConfigBooleanHotkeyed("optMiniHud", false, "", "MiniHud掉帧优化").apply(ALL);
    ...
    @Config(tab = Tab.FUNCTIONS) public static final ConfigStringList MOUNT_LOGGERS_ON_MINIHUD_WHITE_LIST = new ConfigStringList("mountLoggerOnMinihudWhitelist", ImmutableList.of(), ".contains(xxx)").apply(ALL);
    ...
    @Config(tab = Tab.FUNCTIONS) public static final ConfigStringList MOUNT_LOGGERS_ON_MINIHUD_BLACK_LIST = new ConfigStringList("mountLoggerOnMinihudBlacklist", ImmutableList.of(), ".contains(xxx)").apply(ALL);
